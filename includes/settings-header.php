...
<div class='wll-action-links'>
	<a <?php if ( ! isset( $_REQUEST['receive_data'] ) ) { echo "class='active'"; } ?> href="<?php echo admin_url( 'options-general.php?page=wllz-zapier-settings' ); ?>"><?php _e( 'Send Data To Zapier', 'when-last-login-zapier-integration' ); ?></a> | <a <?php if ( isset( $_REQUEST['receive_data'] ) ) { echo "class='active'"; } ?> href="<?php echo admin_url( 'options-general.php?page=wllz-zapier-settings&receive_data=true' ); ?>"><?php _e( 'Receive Data From Zapier', 'when-last-login-zapier-integration' ); ?></a>
</div>
<br/>
