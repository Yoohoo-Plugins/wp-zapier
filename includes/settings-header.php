...
<div class="wp-zapier-settings-header" style="font-size:25px;margin:2% 0 0 0;display:inline-block;">
	...
	<div class="wp-zapier-settings-header-meta" style="font-size:14px;margin-left:5px;display:inline-block;">
		<?php echo "v" . WPZAP_VERSION; ?>
		<span style="margin-left:5px;"><a href="https://yoohooplugins.com/?s=zapier" style="margin-top:-4px;" target="_blank"><?php esc_html_e( 'Documentation', 'wp-zapier' ); ?></a> | <a href="https://yoohooplugins.com/support" target="_blank" style="margin-top:-4px;"><?php esc_html_e( 'Support', 'wp-zapier' ); ?></a></span>
	</div>
</div>
